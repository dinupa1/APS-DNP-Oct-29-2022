...
\begin{textblock}{5.0}(10.5, 2.0)
\begin{figure}
    \centering
    \includegraphics[width = 5.0 cm]{imgs/planes.png}
    \caption{Collins–Soper frame. Cyan, olive and red planes are scattering, lepton and nucleon spin planes, respectively. The color of a vector corresponds to the color of a plane the vector lies in.\citeme{Anikin:2017vvn}}
\end{figure}
\end{textblock}
